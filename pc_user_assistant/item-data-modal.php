    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="updateData">
          ...
          <!--  -->
          <div class="mb-3 row">
            <label for="productnameField" class="col-md-3 form-label">ITEM NAME</label>
            <div class="col-md-9">
              <input type="text" class="form-control" id="productnameField" name="productname"  disabled readonly>
            </div>
          </div>
          ...
          <!--  -->
          <div class="mb-3 row">
            <label for="descriptionField" class="col-md-3 form-label">ITEM DESCRIPTION</label>
            <div class="col-md-9">
              <textarea class="form-control" id="descriptionField" name="description" style="resize: none;" disabled readonly></textarea>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-9">
              <input type="number" class="form-control" id="itemQuantityField" name="itemQuantity" disabled readonly>
            </div>
          </div>
          ...
          <div class="mb-3 row">
            ...
            <div class="col-md-9">
              <select class="form-select" aria-label="Item Name" id="statusOfRequestField" name="statusOfRequest" disabled readonly>
