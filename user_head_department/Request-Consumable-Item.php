...
$errorMsg = array('itemMessage' => '', 'itemId' => '', 'itemQuantity' => '');
$itemId = '';
$itemMessage = '';
$itemQuantity = 0;
...
if(isset($_GET['requestItem'])){
    ...
    if(array_filter($errorMsg)){
        ...
        $sql = "INSERT INTO pc_item_requests (itemId, itemMessage, itemQuantity, requestorId) VALUES ('$itemId', '$itemMessage', '$itemQuantity', '$requestorId') ";
        ...
        <div class="card-body">
            ...
            <form action="Request-Consumable-Item.php" method="GET">
                <div class="row mb-3 gap-2">
                    <div class="col-sm-2">
                        <select class="form-select" aria-label="Item Name" name="itemId" required>
