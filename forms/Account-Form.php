<div class="container-fluid">
  <div class="row mb-3">
            ...
            <div class="row mb-3">
              ...
              <div class="col position-relative">
                <div class="form-floating">
                  <input type="text" class="form-control" id="MN" name="middleName" placeholder="Middle Name" value="<?php echo htmlspecialchars($middleName); ?>" required>
                  <label for="MD position-relative">Middle Name</label>
                  <p class="small text-danger m-auto px-1">
                    <?php echo $errorMsg['middleName']; ?>
                  </p>
                </div>
              </div>
