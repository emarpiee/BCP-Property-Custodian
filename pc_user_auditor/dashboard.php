...
$sql = "SELECT * FROM logistics_warehouse WHERE quantity > 1";
$result = mysqli_query($conn, $sql);
$inventoryItemTotal = mysqli_num_rows($result);
?>
<!DOCTYPE html>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                Available items in inventory</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                    <?php echo $inventoryItemTotal; ?>
                                </div>
                            </div>
                            <div class="col-auto">
