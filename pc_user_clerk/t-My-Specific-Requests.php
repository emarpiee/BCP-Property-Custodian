...
WHERE pc_item_requests.`itemId` = 0 AND accId = '$accId'";
...
<head>
	...
	<title>My Specific Requests</title>
...
<body>
    ...
    <div class="card-header p-3">
      <h2 class="text-center">My Specfici Requests</h2>
    </div>
    <div class="card-body">
            ...
            <tbody>
                ...
                foreach ($rows as $row)
                {
                    ...
                    <tr>
                        ...
                        <td><?php echo $row['itemSpecific'];?></td>
