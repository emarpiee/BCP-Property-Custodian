            ...
            <tbody>
                ...
                foreach ($rows as $row)
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-primary mb-2" href="Approve-Item-Request.php?requestID=<?php echo $row['requestID']; ?>">Approve</a>
                            <a class="btn btn-danger mb-2" href="Decline-Item-Request.php?requestID=<?php echo $row['requestID']; ?>">Decline</a>
                        </td>
