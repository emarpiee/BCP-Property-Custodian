...
$sql = "SELECT * FROM pc_accounts JOIN pc_account_status ON pc_accounts.`accountStatus`= pc_account_status.`statusId` JOIN pc_user_role ON pc_accounts.`roleId` = pc_user_role.`roleId` WHERE accountStatus = 1 ORDER BY pc_accounts.`accId`";
